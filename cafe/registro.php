...
{  
	...
	if (!empty($Nombres && !empty($Apellidos) && !empty($email)&& !empty($pass)))
{
		$sql=$cnnPDO->prepare("INSERT INTO bd_cafe
			(Nombres,Apellidos, email, pass, cpass) VALUES (:Nombres, :Apellidos, :email, :pass, :cpass)");
		
		$sql->bindParam(':Nombres',$Nombres);
		$sql->bindParam(':Apellidos',$Apellidos);
		$sql->bindParam(':email',$email);
		$sql->bindParam(':pass',$pass);
        $sql->bindParam(':cpass',$pass);
		$sql->execute();
		unset($sql);
		unset($cnnPDO);
      ...
      <div class="col">
        <div class="acc-form">
          <div class="log-acc-page">
            ...
            <div class="acc-page">
              <div class="registers">
                <form method="post" id="signupForm" accept-charset="UTF-8"><input type="hidden" name="form_type" value="create_customer" /><input type="hidden" name="utf8" value="✓" />
                <div class="login-form-container">
                  
                  <ul class="fill-form">
                    <li class="fname">
                      
                      <input type="text" name="Nombres" id="Nombres" class="input-full" placeholder="Nombres"  autocapitalize="words" autofocus>
                    </li>

                    <li class="lname">
                      
                      <input type="text" name="Apellidos" id="Apellidos" class="input-full" placeholder="Apellidos"  autocapitalize="words">
                    </li>

                    <li class="log-email">
                      
                      <input type="email" name="email" id="email" class="input-full" placeholder="Correo"  autocorrect="off" autocapitalize="off">
                    </li>

                    <li class="log-pwd">
                      
                      <input type="password" name="pass" id="pass" class="input-full" placeholder="Contraseña">
                    </li>
                    <li class="log-pwd">
                      
                      <input type="password" name="cpass" id="cpass" class="input-full" placeholder="Confirma Contraseña">
                    </li>
                  </ul>
                  <div class="form-action-button">
                    <button id="siguiente" name="siguiente" class="btn btn-style2" type="submit">Crear</button>
                  </div>
                </div>
                </form>
              </div>
              <div class="acc-wrapper">
                ...
                <div class="account-optional-action">
                  <a href="inicios.php" id="customer_login_link">Ingresar</a>
