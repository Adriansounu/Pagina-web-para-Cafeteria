...
{  
    ...
    {  
        $sql = $cnnPDO->prepare(
            'UPDATE bd_cafe SET Nombres = :Nombres, Apellidos = :Apellidos, RFC = :RFC, Direccion = :Direccion, email = :email WHERE Nombres = :Nombres'
        );
...
<html class="no-js supports-no-cookies " lang="en">
  ...
  <script src="http://jqueryvalidation.org/files/dist/jquery.validate.min.js"></script>
    ...
    <link rel="canonical" href="https://labella-store-coffee.myshopify.com/account/register"><link rel="shortcut icon" href="//cdn.shopify.com/s/files/1/0557/1965/7630/files/favicon_32x32.png?v=1630567860" type="image/png" /><!-- Title and description -->
...
<meta property="og:url" content="https://labella-store-coffee.myshopify.com/account/register">
...
<script id="__st">var __st={"a":55719657630,"offset":19800,"reqid":"53208400-9ee5-4c8c-876c-16d7e64691f4","pageurl":"labella-store-coffee.myshopify.com\/account\/register","u":"77eb4ef5ba0a"};</script>
...
<script>window.BOLD = window.BOLD || {};
    ...
    window.BOLD.common.template = 'customers/register';window.BOLD.common.Shopify.formatMoney = function(money, format) {
        function n(t, e) {
...
<ul class="breadcrumb-list">
  ...
  <li class="breadcrumb-item">
    <a href="usuario.php" title="Back to the home page">Usuario</a>
  </li>
          ...
          <div class="log-acc-page">
            <div class="content-main-title">
              <div class="content-cont-title">
                <h2>
                  <span>Datos De <?php echo $_SESSION['Nombres'];
     ?></span>
                </h2>
              ...
              <p>Puedes Agregar tu RFC y Dirección</p>
              
            </div>
            <div class="acc-page">
              <div class="registers">
                <form method="post" id="form" accept-charset="UTF-8"><input type="hidden" name="form_type" value="create_customer" /><input type="hidden" name="utf8" value="✓" />
                <div class="login-form-container">
                  
                  <ul class="fill-form">
                    <li class="fname">
                    <h7>Correo Electronico </h7>
                      <input type="text" readonly=»readonly» value="<?php echo "$email"; ?>" name="email" id="nombre" class="input-full" placeholder="Nombres"  autocapitalize="words" autofocus>
                    </li>

                    <li class="lname">
                    <h7>Nombres</h7>
                      <input type="text" name="Nombres" readonly=»readonly» value="<?php echo "$Nombres"; ?>" id="apellido" class="input-full" placeholder="Apellidos"  autocapitalize="words">
                    </li>

                    <li class="log-email">
                    <h7>Apellidos</h7>
                      <input type="email" name="Apellidos"readonly=»readonly» value="<?php echo "$Apellidos"; ?>" id="email" class="input-full" placeholder="Correo"  autocorrect="off" autocapitalize="off">
                    </li>

                    <li class="log-pwd">
                    <h7>RFC</h7>
                      <input type="text" name="RFC" id="pass" value="<?php echo "$RFC"; ?>" class="input-full" placeholder="RFC">
                    </li>
                    <li class="log-pwd">
                    <h7>Dirección</h7>
                      <input type="text" name="Direccion" value="<?php echo "$Direccion"; ?>" id="cpass" class="input-full" placeholder="Direccion">
                    </li>
                  </ul>
                  <div class="form-action-button">
                   <center> <button id="siguiente" name="Modificar" class="btn btn-style2" type="submit">MODIFICAR</button></center>
                  </div>
                </div>
                </form>
              </div>
...
<style>
  ...
  $( "#form" ).validate({
    ...
    messages:{
      ...
      Nombres: {
            required: "<div class='alert alert-danger' role='alert'> <b>Ingrese su nombre</b> </div>",
            solo_letras_espacios:"<div class='alert alert-danger' role='alert'> <b>El nombre solo debe de tener letras</b> </div>"
          },
          Apellidos: {
            required: "<div class='alert alert-danger' role='alert'> <b>Ingrese su nombre</b> </div>",
            solo_letras_espacios:"<div class='alert alert-danger' role='alert'> <b>El nombre solo debe de tener letras</b> </div>"
      ...
      email: {
            required: "<div class='alert alert-danger' role='alert'> <b>Ingrese su email</b> </div>",
            validaEmail:"<div class='alert alert-danger' role='alert'> <b>El Formato del Email es Incorrecto</b> </div>"
      },
      pass: {
        required: "<div class='alert alert-danger' role='alert'> <b>Ingrese una contraseña</b> </div>",
        minlength: "<div class='alert alert-danger' role='alert'> <b>Tu contraseña debe de tener por lo menos 5 caracteres de longitud</b> </div>",
      },
      cpass: {
        required: "<div class='alert alert-danger' role='alert'> <b>Confirmar contraseña</b> </div>",
        minlength: "<div class='alert alert-danger' role='alert'> <b>Tu contraseña debe de tener por lo menos 5 caracteres de longitud</b> </div>",
        equalTo: "<div class='alert alert-danger' role='alert'> <b>Las Contraseñas debe de ser iguales</b> </div>"
      }
    }
  });
